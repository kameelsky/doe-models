...
class Model:
    ...
    def qq_plot(self) -> None: # Plots a Q-Q plot of residuals.
        ...
        fig = qqplot(data=(self.residuals), ax=ax)
    ...
    def data_plot(self) -> None:
        ...
        ax = axes[0]
        sns.pointplot(data=self.Data, x=self.x_1, y=self.y_i, hue=self.x_2, capsize=0.1, palette='colorblind', errorbar="sd", err_kws={'linewidth': 1}, ax=ax)

        ax = axes[1]
        sns.pointplot(data=self.Data, x=self.x_2, y=self.y_i, hue=self.x_1, capsize=0.1, palette='colorblind', errorbar="sd", err_kws={'linewidth': 1}, ax=ax)
